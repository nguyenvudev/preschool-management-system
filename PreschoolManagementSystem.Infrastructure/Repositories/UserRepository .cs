...
namespace PreschoolManagementSystem.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            return await _context.Users.FirstOrDefaultAsync(u => u.PhoneNumber == phoneNumber && u.IsActive);
        }
        ...
        {
            return await _context.Users.AnyAsync(u => u.Email == email && u.IsActive && u.Id != excludeUserId);
        }
        ...
        public async Task<PagedList<User>> GetPagedAsync(Application.Interfaces.Repositories.UserQuery query)
        {
